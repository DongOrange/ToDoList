...
<template>
  <main class="w-full p-5 pb-10 bg-white shadow-xl rounded-xl lg:rounded-3xl lg:p-10">
    ...
    <div class="flex gap-2 mb-10 lg:gap-5 lg:mb-20">
      <div class="flex-1"><input type="text" aria-label="新增任務" class="w-full h-8 text-lg border border-gray-300 rounded-md px-2 lg:h-12 lg:px-5 lg:rounded-lg"></div>
      <div class="w-14 lg:w-24"><button class="w-full bg-primary text-white text-base h-8 rounded-md lg:rounded-lg lg:text-lg lg:h-12">新增</button></div>
    </div>
    ...
    <div class="mb-10 border-b-2 border-primary lg:mb-20">
      <ul class="flex">
        <li class="flex-1"><button class="tab">全部</button></li>
        <li class="flex-1"><button class="tab">已完成</button></li>
        <li class="flex-1"><button class="tab">未完成</button></li>
      </ul>
    </div>
          ...
          <template>
            <li class="border-b border-gray-300 px-0 py-5 flex lg:p-5">
              ...
              <div class="w-6 lg:w-8">
                <div class="w-full aspect-square rounded-full close-btns bg-red-600" aria-label="刪除任務"></div>
              </div>
            </li>
          </template>
        </ul>
